  ...
  sendRequest = async () => {
    ...
    if (this.state.referenceName === '' && this.state.knowsLeader === false) {
      ...
      if (
        ...
        this.state.knowsLeader &&
        this.state.screenNameReference === false
      ) {
      ...
      <div className='border rounded m-2 p-3 bg-white row'>
        <div className='col-md-9'>
          ...
          <h4>
            ...
            <span className='font-weight-light'>{this.state.zip}</span>
          </h4>
        </div>
        <div className='col-md-3'>
          <button
            ...
            data-toggle='modal'
            data-target={'#ModalCenter' + this.state.poolId}
          >
            Join this pool
          </button>
        </div>
        ...
        <div
          ...
          id={'ModalCenter' + this.state.poolId}
          tabIndex='-1'
          role='dialog'
