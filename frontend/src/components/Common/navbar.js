        ...
        if (this.props.isAdmin) {
            return (
                <div className="row text-center border-bottom pb-3 stickyNavBar bg-light">
                    <div className="col-md-2 border-left border-right"><a href="/admin/browse" className="text-secondary text-decoration-none"><p>View my stores</p></a></div>
                    <div className="col-md-2 border-left border-right"><a href="/admin/store/add" className="text-secondary text-decoration-none"><p>Add Stores</p></a></div>
                    <div className="col-md-2 border-left border-right"><a href="/admin/product/add" className="text-secondary text-decoration-none"><p>Add products</p></a></div>
                    <div className="col-md-2 border-left border-right"><a href="" className="text-secondary text-decoration-none"><p>View orders</p></a></div>
                    <div className="col-md-2 border-left border-right"><a href="" className="text-secondary text-decoration-none"><p>Something else</p></a></div>
