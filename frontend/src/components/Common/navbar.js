        ...
        if (this.props.isAdmin) {
            return (
                <div className="row text-center border-bottom pb-3 stickyNavBar bg-light">
                    <div class="col-md-2 border-left border-right"><a href="/admin/browse/stores" class="text-secondary text-decoration-none"><p>View stores</p></a></div>
                    <div class="col-md-2 border-left border-right"><a href="/admin/browse/products" class="text-secondary text-decoration-none"><p>View all products</p></a></div>
